...
describe('StrategyVotingSystem', function () {
    beforeEach(function () {
    ...
    it('handles empty strategy collection', function () {
    ...
    it('works with mock strategy that returns matches', function () {
        ...
        $mockStrategy = new class implements DetectionStrategy {
            public function detect(string $text, ?Language $language = null): MatchCollection {
                ...
                if (str_contains(strtolower($text), 'fuck')) {
                    $position = strpos(strtolower($text), 'fuck');
    ...
    it('works with clean text and mock strategy', function () {
        $mockStrategy = new class implements DetectionStrategy {
            public function detect(string $text, ?Language $language = null): MatchCollection {
    ...
    it('handles multiple strategies with voting', function () {
        ...
        $strategy1 = new class implements DetectionStrategy {
            ...
            public function weight(): float { return 1.0; }
            public function efficiency(): float { return 1.0; }
            public function name(): string { return 'strategy1'; }
        };
        ...
        $strategy2 = new class implements DetectionStrategy {
            public function detect(string $text, ?Language $language = null): MatchCollection {
                ...
                if (str_contains(strtolower($text), 'shit')) {
                    $position = strpos(strtolower($text), 'shit');
                    $matches->addCoincidence(new Coincidence(
                        word: 'shit',
                        type: MatchType::Exact,
                        score: new Score(0.7),
            ...
            public function weight(): float { return 1.0; }
            public function efficiency(): float { return 1.0; }
            public function name(): string { return 'strategy2'; }
        };
    ...
    it('works without language parameter', function () {
        $mockStrategy = new class implements DetectionStrategy {
            ...
            public function weight(): float { return 1.0; }
            public function efficiency(): float { return 1.0; }
            public function name(): string { return 'mock_strategy'; }
        };
