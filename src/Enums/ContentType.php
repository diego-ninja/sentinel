...
enum ContentType: string
{
    ...
    public function prompt(): string
    {
        return match ($this) {
            ...
            ContentType::Legal => "  This is legal content. Legal terminology and case discussions may include potentially offensive terms in a professional language.\n",
            ...
            ContentType::News => "  This is news content. Consider journalistic language and quoted material when assessing offensive content.\n",
