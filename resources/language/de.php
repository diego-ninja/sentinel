...
/**
 * German language definitions for profanity detection
 * These define contextual words and patterns that help analyze the severity and intent
 * of potentially offensive content.
 */
return [
    'offensive_words' => [
        'arschfotze', 'arschgeige', 'arschgesicht', 'arschloch', 'fotze', 'bulle', 'furz',
        'depp', 'möpse', 'drecksau', 'bastard', 'fick', 'muschi', 'sackgesicht', 'kackbratze',
        'hurensohn', 'trottel', 'dummbatz', 'schlampe', 'dummkopf', 'fettbacke', 'fotze',
        'hirnlos', 'kack', 'luder', 'stricher', 'miststück', 'muterfiker', 'mutterficker',
        'onanieren', 'pisser', 'scheissen', 'scheißhaus', 'schise', 'schlampe',
        'schwanz', 'schwanzlutscher', 'schweinepriester', 'schwuchtel', 'schwul',
        'schwuler', 'scheisse', 'scheiße', 'scheise', 'trottel', 'fick', 'ficken', 'jud',
        'jude', 'nazi', 'nsdap', 'dreck', 'wichser', 'wixer', 'wixen', 'sau', 'bums', 'arschloch',
        'arsch', 'schwanz', 'fotze', 'hure', 'schlampe', 'titten', 'fotz', 'hitler', 'heil', 'opfer',
    ],
