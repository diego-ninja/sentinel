...
/**
 * French language definitions for profanity detection
...
return [
    ...
    'prefixes' => [
        'dé', 're', 'dis', 'més', 'pré', 'sur', 'sous', 'sous', 'super', 'anti', 'auto', 'bi', 'co', 'dé', 'en', 'ex',
        'avant', 'in', 'inter', 'mi', 'non', 'extra', 'post', 'semi', 'tri', 'in', 'sous', 'hausse', 'avec',
    ],
    'suffixes' => [
        'ant', 'issant', 'issant', 'é', 'i', 'u', 'eur', 'euse', 'ier', 'ière', 'iste', 'aire', 's', 'x', 'eurs',
        'euses', "'s", 's', 'x', 'issime', 'issime', 'ment', 'ier', 'ière', 'issime', 'issime',
    ],
